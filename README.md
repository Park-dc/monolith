[![Build Status](https://dev.azure.com/userproject/user07devops/_apis/build/status/user07devops-CI?branchName=master)](https://dev.azure.com/userproject/user07devops/_build/latest?definitionId=2&branchName=master)
